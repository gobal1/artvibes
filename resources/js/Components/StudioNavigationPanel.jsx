...
import { LayoutDashboard, DollarSign, Heart, Bell, MessageSquare } from 'lucide-react';
...
export default function StudioNavigationPanel({ navigateTo, active = 'dashboard' }) {
  const actions = [
    ...
    { id: 'chat', label: 'Chat', icon: MessageSquare, onClick: () => navigateTo('dashboard') },
  ...
  return (
    <aside className="fixed inset-y-0 right-0 z-30 h-dvh min-h-dvh w-14 flex flex-col items-center justify-between border-l border-white/10 bg-slate-950 p-3 shadow-[0_35px_60px_-30px_rgba(0,0,0,0.8)]">
