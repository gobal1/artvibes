import { N as StorageUtil, Y as ConstantsUtil$1, h as ConnectorController, r as ChainController } from "./ApiController-B0o4XNV_.js";
...
//#endregion
//#region node_modules/@reown/appkit-ui/dist/esm/src/utils/MathUtil.js
var MathUtil = { interpolate(inputRange, outputRange, value) {
...
//#endregion
//#region node_modules/@reown/appkit-ui/dist/esm/src/utils/ThemeConstantsUtil.js
var colors = {
	black: "#202020",
	white: "#FFFFFF",
...
//#endregion
//#region node_modules/@reown/appkit-ui/dist/esm/src/utils/ThemeHelperUtil.js
var PREFIX_VAR = "--apkt";
...
function css(strings, ...values) {
	return css$1(strings, ...values.map((value) => typeof value === "function" ? unsafeCSS(value(vars)) : unsafeCSS(value)));
}
//#endregion
...
function createRootStyles(_themeVariables) {
	return {
		core: css$1`
      ${Boolean(_themeVariables?.["--apkt-font-family"] || _themeVariables?.["--w3m-font-family"]) ? css$1`` : css$1`
            @font-face {
              font-family: 'KHTeka';
              src:
...
var UiHelperUtil = {
	getSpacingStyles(spacing, index) {
		if (Array.isArray(spacing)) return spacing[index] ? `var(--apkt-spacing-${spacing[index]})` : void 0;
		else if (typeof spacing === "string") return `var(--apkt-spacing-${spacing})`;
	},
...
var HelpersUtil = {
	...
	*/
	userChainIdToChainNamespace(chainId) {
		if (typeof chainId === "number") return ConstantsUtil$1.CHAIN.EVM;
	...
	*/
	getOtherAuthNamespaces(activeNamespace) {
		...
		return ConstantsUtil$1.AUTH_CONNECTOR_SUPPORTED_CHAINS.filter((ns) => ns !== activeNamespace);
	},
	/**
...
//#endregion
export { css$1 as S, noChange as _, elementStyles as a, defaultConverter as b, setColorTheme as c, vars as d, MathUtil as f, mathml as g, html as h, UiHelperUtil as i, setThemeVariables as l, _$LH as m, ConstantsUtil as n, initializeTheming as o, LitElement as p, customElement as r, resetStyles as s, HelpersUtil as t, css as u, nothing as v, notEqual as x, svg as y };

//# sourceMappingURL=HelpersUtil-CfRZX8Fm.js.map